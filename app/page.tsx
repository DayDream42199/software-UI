...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-neutral-800 flex flex-col items-center justify-center p-4">
      ...
      {/* Mobile Phone Frame */}
      <div className="relative h-[812px] w-full max-w-[390px] overflow-hidden rounded-[34px] bg-neutral-900 p-[8px] shadow-[0_24px_60px_rgba(0,0,0,0.4)]">
        ...
        {/* App Content */}
        <div
          className="relative flex h-full flex-col overflow-hidden rounded-[26px] bg-background"
          ...
          {isLoggedIn ? (
            <>
              ...
              {showFallNotificationScreen && (
                <div
                  className="absolute inset-0 z-40 overflow-hidden bg-[radial-gradient(circle_at_top,_#d9e6ff,_#adc9f4_45%,_#7ca6d9_100%)]"
                  style={{ clipPath: "inset(0 round 0 0 26px 26px)" }}
                >
            ...
            <div className="flex flex-1 flex-col bg-[#f4f7fb] px-5 py-8">
